...
class LayerExportPlugin {
    ...
    bindEvents() {
        ...
        this.elements = {
            ...
            exportSize: document.querySelector('input[name="exportSize"]:checked'), // Added size selection
    ...
    async exportLayers(layersToExport) {
        ...
        const selectedSize = parseInt(document.querySelector('input[name="exportSize"]:checked').value); // Get selected size
        ...
        this.log(`Starting export of ${layersToExport.length} layer(s) at ${options.size}x...`, 'info');
        ...
        const suspendHistory = await core.executeAsModal(async () => {
            try {
                ...
                try {
                    ...
                    // Resize if export size is 2x
                    if (options.size === 2) {
                        const originalWidth = exportDoc.width;
                        const originalHeight = exportDoc.height;
                        ...
                        await action.batchPlay([{
                            ...
                            freeTransformCenterState: { _enum: "centerState", _value: "centerXFY" },
                            width: { _unit: "percentUnit", _value: 200 },
                            height: { _unit: "percentUnit", _value: 200 },
                            interpolation: { _enum: "interpolationType", _value: "bicubicSharper" } // Or choose another interpolation method
                        }], {});
                    }
